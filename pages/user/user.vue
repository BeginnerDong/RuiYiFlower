<template>
	<view>
		<view class="p-r">
			...
			<view class="p-r p-3 color2 font-24 line-h d-flex">
				<image src="../../static/images/vip-img.png" class="userImg"></image>
				<view class="font-30 colorf pt-1 pl-2">
					<view class="pb-2">帕拉欧度</view>
					<view class="font-22 p-r">
						<image src="../../static/images/about-icon.png" class="userVip"></image>
						<view class="p-r line-h-md pl-4">会员</view>
					</view>
				</view>
			</view>
			<view class="bg-black mx-4  p-3 pb-5 p-r colorG font-32 d-flex j-sb a-center radius20-T yy" @click="Router.redirectTo({route:{path:'/pages/user-surplus/user-surplus'}})">
				<view class="d-flex a-center">1256<text class="font-22 pl-1">(余额)</text></view>
				<view class="font-24 d-flex a-center">查看<image src="../../static/images/about-icon1.png" class="R-icon"></image></view>
			</view>
		</view>
			...
			<view class="p-r color2">
				...
				<view class="px-3 bB-f5 pb-4">
					...
					<view class="d-flex j-sb a-end">
						<view class="font-24 d-flex a-center flex-column" @click="Router.redirectTo({route:{path:'/pages/user-coupon/user-coupon'}})">
							<image src="../../static/images/about-icon5.png" class="user-icon"></image>
							<view>优惠券</view>
						</view>
						<view class="font-24 d-flex a-center flex-column" @click="Router.redirectTo({route:{path:'/pages/user-address/user-address'}})">
							<image src="../../static/images/about-icon6.png" class="user-icon1"></image>
							<view>收获地址</view>
						</view>
						<view class="font-24 d-flex a-center flex-column" @click="Router.redirectTo({route:{path:'/pages/user-share/user-share'}})">
							<image src="../../static/images/about-icon7.png" class="user-icon2"></image>
							<view>我的分享</view>
						</view>
						<view class="font-24 d-flex a-center flex-column" @click="Router.redirectTo({route:{path:'/pages/user-browse/user-browse'}})">
							<image src="../../static/images/about-icon8.png" class="user-icon3"></image>
							<view>浏览记录</view>
						</view>
						<view class="font-24 d-flex a-center flex-column" @click="Router.redirectTo({route:{path:'/pages/user-aboutUs/user-aboutUs'}})">
				...
				<view class="px-3 pb-4">
					...
					<view class="d-flex a-end">
						<view class="font-24 d-flex a-center flex-column mr-5" @click="Router.redirectTo({route:{path:'/pages/user-zitiEntrance/user-zitiEntrance'}})">
							<image src="../../static/images/about-icon10.png" class="user-icon5"></image>
							<view>自提入口</view>
						</view>
						<view class="font-24 d-flex a-center flex-column ml-1" @click="Router.redirectTo({route:{path:'/pages/user-Distributor/user-Distributor'}})">
...
.userImg{width: 90rpx;height: 90rpx;}
