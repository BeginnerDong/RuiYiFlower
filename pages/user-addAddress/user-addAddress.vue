	...
	<view>
		<view class="add px-3 font-28 mb-4">
			<view class="flex1 py-4 bB-f5">
				<view>姓名</view>
				<input type="text" v-model="submitData.name" placeholder="填写姓名" />
			</view>
			<view class="flex1 py-4 bB-f5">
				<view>手机号</view>
				<input type="number" maxlength="11"  v-model="submitData.phone" placeholder="填写手机号" />
			</view>
			<view class="flex1 py-4 bB-f5">
				<view>所在地区</view>
				<view class="flex1 font-22 color9" @click="chooseAddress()">
			...
			<view class="flex1 py-4 bB-f5">
				<view>设为默认地址</view>
				<!-- <image src="../../static/images/addressl-icon3.png" class="add-icon2"></image> -->
				<!-- <image src="../../static/images/addressl-icon4.png" class="add-icon2"></image> -->
				<switch style="transform:scale(0.75);" @change="choose" :checked="submitData.isdefault==1?true:false" color="#FF6740" />
			</view>
		</view>
		
		<view class="btn690" @click="Utils.stopMultiClick(submit)">确定</view>
	</view>
</template>
